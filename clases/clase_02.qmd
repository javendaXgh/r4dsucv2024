...
conjunto de archivos ("files" ) que conforman un determinado análisis, página web, presentación, libro, etc. Al crearse hay algunos archivos que se crean automáticamente .Rproj
